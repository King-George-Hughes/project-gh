const Home = () => {
  return (
    <div className="w-full h-screen px-4 py-5 flex items-center justify-center">
      <div className="container mx-auto gap-5 lg:gap-20 flex flex-col md:flex-row items-center justify-center mt-40 lg:mt-0">
